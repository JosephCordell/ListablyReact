        ...
        <>
          <div className={'similar-card'}>
              <div 
                ...
                data-type={type}
              />  
              <button onClick={openModal} className={'button-modal'}><img src={`https://image.tmdb.org/t/p/w500${ similarThing.poster_path }`} alt="similarThing" className={'similar-image'} /></button>
