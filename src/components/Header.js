        ...
        <div className={'search'}>
            <div className={'input-group mb-3'}>
                <select className={'search-dropdown'}>
                    <option  classID={"dropdown"} className={'dropdown-item'} value="1">Movies</option>
                    <option className={'dropdown-item'} classID={"dropdown"} value="2">TV Shows</option>
                </select>
    ...
    (<div className={'login'}>
        <div className={'collapse navbar-collapse'} classID={"navbarNav"}>
            <ul className={'navbar-nav'}>
                ...
                <li className={'nav-item'}>
                    <a className={'nav-link'} href="" classID={"logout"}>Logout</a>
                </li>
            </ul>
            </div>
            </div>)
